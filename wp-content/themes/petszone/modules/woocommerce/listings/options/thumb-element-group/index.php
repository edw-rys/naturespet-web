...
if( !class_exists( 'PetsZone_Woo_Listing_Option_Thumb_Element_Group' ) ) {

    class PetsZone_Woo_Listing_Option_Thumb_Element_Group extends PetsZone_Woo_Listing_Option_Core {
        ...
        function render_backend() {
            ...
            add_filter( 'petszone_woo_custom_product_template_thumb_options', array( $this, 'woo_custom_product_template_thumb_options'), 55, 1 );
        }
...
if( !function_exists('petszone_woo_listing_option_thumb_element_group') ) {
	function petszone_woo_listing_option_thumb_element_group() {
		return PetsZone_Woo_Listing_Option_Thumb_Element_Group::instance();
	}
}

petszone_woo_listing_option_thumb_element_group();