...
if( !class_exists( 'PetsZone_Woo_Listing_Shop' ) ) {

    class PetsZone_Woo_Listing_Shop {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'petszone_woo_shop_page_default_settings', $this->settings );
...
if( !function_exists('petszone_woo_listing_shop') ) {
	function petszone_woo_listing_shop() {
		return PetsZone_Woo_Listing_Shop::instance();
	}
}

petszone_woo_listing_shop();