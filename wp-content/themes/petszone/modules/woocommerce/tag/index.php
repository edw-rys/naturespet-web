...
if( !class_exists( 'PetsZone_Woo_Listing_Tag' ) ) {

    class PetsZone_Woo_Listing_Tag {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'petszone_woo_tag_page_default_settings', $this->settings );
...
if( !function_exists('petszone_woo_listing_tag') ) {
	function petszone_woo_listing_tag() {
		return PetsZone_Woo_Listing_Tag::instance();
	}
}

petszone_woo_listing_tag();