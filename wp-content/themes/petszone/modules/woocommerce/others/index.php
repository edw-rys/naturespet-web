...
if( !class_exists( 'PetsZone_Woo_Others' ) ) {

    class PetsZone_Woo_Others {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'petszone_woo_others_settings', $this->settings );
...
if( !function_exists('petszone_woo_others') ) {
	function petszone_woo_others() {
		return PetsZone_Woo_Others::instance();
	}
}
