...
if( !class_exists( 'PetsZone_Shop_Single_Module_Upsell_Related' ) ) {

    class PetsZone_Shop_Single_Module_Upsell_Related {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( petszone_is_file_in_theme( __FILE__ ) ) {
                    return PETSZONE_MODULE_DIR . '/woocommerce/single/modules/upsell-and-related/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( petszone_is_file_in_theme( __FILE__ ) ) {
                    return PETSZONE_MODULE_URI . '/woocommerce/single/modules/upsell-and-related/';
                } else {
        ...
        */
            function woo_load_listing( $product_style_template, $product_style_custom_template ) {
                ...
                if( $product_style_template == 'predefined' ) {
                    $type_class_instance = 'petszone_woo_listing_type_'.$product_style_custom_template; // Type Class Instance
...
if( !function_exists('petszone_shop_single_module_upsell_related') ) {
	function petszone_shop_single_module_upsell_related() {
		return PetsZone_Shop_Single_Module_Upsell_Related::instance();
	}
}

petszone_shop_single_module_upsell_related();