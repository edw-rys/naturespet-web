...
class WeDesignTech_Widget_Base_Heading {
	...
	public function render_title_html($settings) {
		...
		if(isset($settings['title']) && !empty($settings['title'])) {
			$output .= '<'.esc_attr($settings['title_tag']).' class="wdt-heading-title-wrapper wdt-heading-align-'.esc_attr(isset($settings['title_vertical_align'])).' '.esc_attr($deco_class).'">';
	...
	public function render_subtitle_html($settings) {
		...
		if(isset($settings['subtitle']) && !empty($settings['subtitle'])) {
			$output .= '<div class="wdt-heading-subtitle-wrapper wdt-heading-align-'.esc_attr(isset($settings['subtitle_vertical_align'])).' '.esc_attr($deco_class).'">';
