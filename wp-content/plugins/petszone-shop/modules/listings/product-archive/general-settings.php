...
if( !class_exists( 'PetsZone_Woo_Listing_Fw_Archive_General_Settings' ) ) {

    class PetsZone_Woo_Listing_Fw_Archive_General_Settings {
        ...
        function __construct($shop_custom_options) {
            ...
            /* Update Archive Default Options */
                add_filter( 'petszone_woo_shop_page_default_settings', array( $this, 'shop_page_default_settings' ), 20, 1 );
