...
class PetsZone_Customize_Control_Responsive_Spacing extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'petszone-plus-responsive-spacing-control', PETSZONE_PLUS_DIR_URL.'customizer/controls/responsive-spacing/responsive-spacing.js', array( 'jquery', 'customize-base' ), PETSZONE_PLUS_VERSION, true );
		wp_enqueue_style( 'petszone-plus-responsive-spacing-control',  PETSZONE_PLUS_DIR_URL.'customizer/controls/responsive-spacing/responsive-spacing.css', null, PETSZONE_PLUS_VERSION );
	}
