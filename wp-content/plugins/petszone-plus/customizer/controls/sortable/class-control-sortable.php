...
class PetsZone_Customize_Control_Sortable extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'petszone-plus-sortable-control', PETSZONE_PLUS_DIR_URL.'customizer/controls/sortable/sortable.js', array( 'jquery', 'customize-base' ), PETSZONE_PLUS_VERSION, true );
		wp_enqueue_style( 'petszone-plus-sortable-control',  PETSZONE_PLUS_DIR_URL.'customizer/controls/sortable/sortable.css', null, PETSZONE_PLUS_VERSION );
	}
