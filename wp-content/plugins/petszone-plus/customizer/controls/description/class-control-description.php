...
class PetsZone_Customize_Control_Description extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'petszone-plus-description-control',  PETSZONE_PLUS_DIR_URL.'customizer/controls/description/description.css', null, PETSZONE_PLUS_VERSION );
	}
