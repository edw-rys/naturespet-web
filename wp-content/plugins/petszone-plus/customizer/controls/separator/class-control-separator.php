...
class PetsZone_Customize_Control_Separator extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'petszone-plus-separator-control',  PETSZONE_PLUS_DIR_URL.'customizer/controls/separator/separator.css', null, PETSZONE_PLUS_VERSION );
	}
