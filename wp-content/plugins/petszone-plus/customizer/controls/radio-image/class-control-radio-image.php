...
class PetsZone_Customize_Control_Radio_Image extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'petszone-plus-radio-image-control', PETSZONE_PLUS_DIR_URL . 'customizer/controls/radio-image/radio-image.js', array( 'jquery', 'customize-base' ), PETSZONE_PLUS_VERSION, true );
		wp_enqueue_style( 'petszone-plus-radio-image-control',  PETSZONE_PLUS_DIR_URL . 'customizer/controls/radio-image/radio-image.css', null, PETSZONE_PLUS_VERSION );
	}
