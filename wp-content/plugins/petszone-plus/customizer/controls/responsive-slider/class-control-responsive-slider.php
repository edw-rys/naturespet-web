...
class PetsZone_Customize_Control_Responsive_Slider extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'petszone-plus-responsive-slider-control', PETSZONE_PLUS_DIR_URL . 'customizer/controls/responsive-slider/responsive-slider.js', array( 'jquery', 'customize-base' ), PETSZONE_PLUS_VERSION, true );
		wp_enqueue_style( 'petszone-plus-responsive-slider-control',  PETSZONE_PLUS_DIR_URL . 'customizer/controls/responsive-slider/responsive-slider.css', null, PETSZONE_PLUS_VERSION );
	}
