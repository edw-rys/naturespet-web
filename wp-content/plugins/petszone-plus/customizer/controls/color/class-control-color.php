...
class PetsZone_Customize_Control_Color extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'petszone-plus-color-control', PETSZONE_PLUS_DIR_URL.'customizer/controls/color/color.js', array( 'jquery', 'customize-base' , 'petszone-plus-customizer-color-picker' ), PETSZONE_PLUS_VERSION, true );
		wp_enqueue_style( 'petszone-plus-color-control',  PETSZONE_PLUS_DIR_URL.'customizer/controls/color/color.css', null, PETSZONE_PLUS_VERSION );
	}
