...
class PetsZone_Customize_Control_Fontawesome extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'petszone-plus-fontawesome-control', PETSZONE_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.js', array( 'jquery', 'customize-base' ), PETSZONE_PLUS_VERSION, true );
		wp_enqueue_style( 'petszone-plus-fontawesome-control',  PETSZONE_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.css', null, PETSZONE_PLUS_VERSION );

		wp_enqueue_style( 'petszone-plus-fontawesome',  PETSZONE_PLUS_DIR_URL . 'customizer/assets/css/fontawesome-all.css', array(),PETSZONE_PLUS_VERSION, 'all' );
	}
	...
	public function to_json() {
		...
		$this->json['reset'] = esc_html__( "Reset", "petszone-plus") .' '.esc_html( $this->label );
