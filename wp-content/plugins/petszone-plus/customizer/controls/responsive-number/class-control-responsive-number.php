...
class PetsZone_Customize_Control_Responsive_Number extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'petszone-plus-responsive-number-control', PETSZONE_PLUS_DIR_URL . 'customizer/controls/responsive-number/responsive-number.js', array( 'jquery', 'customize-base' ), PETSZONE_PLUS_VERSION, true );
		wp_enqueue_style( 'petszone-plus-responsive-number-control',  PETSZONE_PLUS_DIR_URL . 'customizer/controls/responsive-number/responsive-number.css', null, PETSZONE_PLUS_VERSION );
	}
