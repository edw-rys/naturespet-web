;(function ( $, window, document, undefined ) {
    'use strict';
    $.PETSZONEPLUSWPCUSTOMIZER = $.PETSZONEPLUSWPCUSTOMIZER || {};

	$.PETSZONEPLUSWPCUSTOMIZER.DEPENDENCY = function( el, param ) {
	...
	$.fn.PETSZONEPLUSWPCUSTOMIZER_DEPENDENCY = function ( param ) {
		return this.each(function () {
			new $.PETSZONEPLUSWPCUSTOMIZER.DEPENDENCY( this, param );
		});
	};

	$(document).ready( function() {
		$('.wp-customizer').PETSZONEPLUSWPCUSTOMIZER_DEPENDENCY();
	});
