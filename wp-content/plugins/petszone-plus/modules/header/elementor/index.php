...
if( !class_exists( 'PetsZonePlusHeaderElementor' ) ) {
    class PetsZonePlusHeaderElementor {
        ...
        function frontend() {
            add_filter( 'petszone_print_header_template', array( $this, 'register_header_template' ), 10, 1 );
        }
		...
		function register_header_template( $id ) {
            ...
            return apply_filters( 'petszone_plus_header_content', $content );
		}
    }
}

PetsZonePlusHeaderElementor::instance();