...
if( !class_exists( 'PetsZonePlusSidebar' ) ) {
    class PetsZonePlusSidebar {
        ...
        function load_modules() {
            include_once PETSZONE_PLUS_DIR_PATH.'modules/sidebar/customizer/index.php';
        }

        function frontend() {
            add_filter('petszone_primary_classes', array( $this, 'primary_classes' ), 10 );
            add_filter('petszone_secondary_classes', array( $this, 'secondary_classes' ), 10 );
        }
