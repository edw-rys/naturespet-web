...
class Elementor_Header_Icons extends PetsZoneElementorWidgetBase {
	...
	public function get_title() {
		return esc_html__( 'Header Icons', 'petszone-plus' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'header_icons_general_section', array(
			...
			$this->add_control( 'show_search_icon', array(
				'label'        => esc_html__( 'Show Search Icon', 'petszone-plus' ),
			...
			$this->add_control( 'search_icon_src', array(
				'label'        => esc_html__( 'Search Icon', 'petszone-plus' ),
			...
			$this->add_control( 'search_type', array(
				'label'       => esc_html__( 'Search Type', 'petszone-plus' ),
				'type'        => Controls_Manager::SELECT,
				'description' => esc_html__( 'Choose type of search form to use.', 'petszone-plus'),
				'default'     => '',
				'options'     => array(
					''      => esc_html__( 'Default', 'petszone-plus'),
					'expand' => esc_html__( 'Expand', 'petszone-plus' ),
					'overlay' => esc_html__( 'Overlay', 'petszone-plus' )
				),
				'condition' => array( 'show_search_icon' => 'yes' )
			) );

			$this->add_control( 'show_userauthlink_icon', array(
				'label'        => esc_html__( 'Show Login / Logout Icon', 'petszone-plus' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => 'yes',
			) );
			...
			$this->add_control( 'userauthlink_icon_src', array(
				'label'        => esc_html__( 'User Logged Out Icon', 'petszone-plus' ),
				'type'         => Controls_Manager::ICONS,
				'default' => array(
					'value' => 'far fa-user',
					'library' => 'fa-regular',
            ...
            $this->add_control( 'userauthlink_loggedin_icon_src', array(
				'label'        => esc_html__( 'User Logged In Icon', 'petszone-plus' ),
				'type'         => Controls_Manager::ICONS,
				'default' => array(
					'value' => 'fas fa-user',
					'library' => 'fa-solid',
			...
			$this->add_control( 'show_cart_icon', array(
				'label'        => esc_html__( 'Show Cart Icon', 'petszone-plus' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => 'yes',
			) );
			...
			$this->add_control( 'cart_icon_src', array(
				'label'        => esc_html__( 'Cart Icon', 'petszone-plus' ),
				'type'         => Controls_Manager::ICONS,
				'default' => array(
			...
			$this->add_control( 'cart_action', array(
				'label'       => esc_html__( 'Cart Action', 'petszone-plus' ),
				'type'        => Controls_Manager::SELECT,
				'description' => esc_html__( 'Choose how you want to display the cart content.', 'petszone-plus'),
				'default'     => '',
				'options'     => array(
					''                    => esc_html__( 'None', 'petszone-plus'),
					'notification_widget' => esc_html__( 'Notification Widget', 'petszone-plus' ),
					'sidebar_widget'      => esc_html__( 'Sidebar Widget', 'petszone-plus' ),
				),
				'condition' => array( 'show_cart_icon' => 'yes' )
	        ) );

			$this->add_control( 'show_wishlist_icon', array(
				'label'        => esc_html__( 'Show Wishlist Icon', 'petszone-plus' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => 'yes',
			) );
			...
			$this->add_control( 'wishlist_icon_src', array(
				'label'        => esc_html__( 'Wishlist Icon', 'petszone-plus' ),
				'type'         => Controls_Manager::ICONS,
				'default' => array(
					'value' => 'far fa-heart',
					'library' => 'fa-regular',
        ...
        $this->start_controls_section( 'wdt_section_color', array(
        	'label'      => esc_html__( 'Colors', 'petszone-plus' ),
			'tab'        => Controls_Manager::TAB_STYLE,
			'show_label' => false,
		) );

			$this->add_control( 'icons_color', array(
				'label'     => esc_html__( 'Icons Color', 'petszone-plus' ),
			...
			$this->add_control( 'icons_hover_color', array(
				'label'     => esc_html__( 'Icons Hover Color', 'petszone-plus' ),
				'type'      => Controls_Manager::COLOR,
				'default' 	=> '',
			...
			if(is_page()) {
					...
					$output .= '<div class="wdt-header-icons-list-item user-authlink-item">';
						...
						if (is_user_logged_in()) {
                            ...
                            $output .= '<div class="wdt-user-authlink-menu-icon">';
                                ...
                                $output .= '<span class="icotype-label">'.esc_html__('Log Out', 'petszone-plus').'</span></span></a>';
                            $output .= '</div>';
							...
							$output .= '<div class="wdt-user-authlink-menu-icon">';
								$output .= '<a href="'.wp_login_url(get_permalink()).'"><span>';
									...
									$output .= '<span class="icotype-label">'.esc_html__('Log In', 'petszone-plus').'</span></span></a>';
							$output .= '</div>';
						}
						...
						$output .= '<div class="wdt-shop-menu-icon">';
							...
							if($settings['cart_action'] == 'notification_widget') {
								...
								$output .= '<div class="wdt-shop-menu-cart-content-wrapper">';
									$output .= '<div class="wdt-shop-menu-cart-content">'.esc_html__('No products added!', 'petszone-plus').'</div>';
								$output .= '</div>';
				...
				if( $settings['show_wishlist_icon'] == 'yes' ) {
					...
					if ( shortcode_exists( 'ti_wishlist_products_counter' ) ) {
						...
						$output .= '<div class="wdt-header-icons-list-item wdt-wishlist-count">'.do_shortcode('[ti_wishlist_products_counter]').'</div>';
