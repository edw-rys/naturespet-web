...
if( !class_exists( 'PetsZonePlusCustomizerSiteToTop' ) ) {
    class PetsZonePlusCustomizerSiteToTop {
        ...
        function register_general( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new PetsZone_Customize_Section(
                    ...
                    'site-to-top-section',
                    array(
                        'title'    => esc_html__('To Top', 'petszone-plus'),
                ...
                $wp_customize->add_setting(
                    PETSZONE_CUSTOMISER_VAL . '[show_site_to_top]', array(
                        'type' => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new PetsZone_Customize_Control_Switch(
                        $wp_customize, PETSZONE_CUSTOMISER_VAL . '[show_site_to_top]', array(
                            'type'    => 'wdt-switch',
                            'section' => 'site-to-top-section',
                            'label'   => esc_html__( 'Enable To Top', 'petszone-plus' ),
                            'choices' => array(
...
PetsZonePlusCustomizerSiteToTop::instance();