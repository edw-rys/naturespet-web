...
if( !class_exists( 'PetsZonePlusH1Settings' ) ) {
    class PetsZonePlusH1Settings {
        ...
        function __construct() {
            ...
            $this->selector = apply_filters( 'petszone_h1_selector', array( 'h1' ) );
            $this->settings = petszone_customizer_settings('h1_typo');

            add_filter( 'petszone_plus_customizer_default', array( $this, 'default' ) );
            add_action( 'customize_register', array( $this, 'register' ), 20);

            add_filter( 'petszone_h1_typo_customizer_update', array( $this, 'h1_typo_customizer_update' ) );
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new PetsZone_Customize_Section(
                    ...
                    'site-h1-section',
                    array(
                        'title'    => esc_html__('H1 Typography', 'petszone-plus'),
             ...
             */
                $wp_customize->add_setting(
                    PETSZONE_CUSTOMISER_VAL . '[h1_typo]', array(
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new PetsZone_Customize_Control_Typography(
                        $wp_customize, PETSZONE_CUSTOMISER_VAL . '[h1_typo]', array(
                            'type'    => 'wdt-typography',
                            'section' => 'site-h1-section',
                            'label'   => esc_html__( 'H1 Tag', 'petszone-plus')
                        )
                    )
                );
             ...
             */
                $wp_customize->add_setting(
                    PETSZONE_CUSTOMISER_VAL . '[h1_color]', array(
                        'default' => '',
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new WP_Customize_Color_Control(
                        $wp_customize, PETSZONE_CUSTOMISER_VAL . '[h1_color]', array(
        ...
        function h1_typo_customizer_update( $defaults ) {
            $h1_typo = petszone_customizer_settings( 'h1_typo' );
            if( !empty( $h1_typo ) ) {
                return  $h1_typo;
            }
            return $defaults;
        ...
        function base_style( $style ) {
            $css   = '';
            $color = petszone_customizer_settings('h1_color');
...
PetsZonePlusH1Settings::instance();