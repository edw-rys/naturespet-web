...
if( !class_exists( 'PetsZonePlusH5Settings' ) ) {
    class PetsZonePlusH5Settings {
        ...
        function __construct() {
            $this->selector = apply_filters( 'petszone_h5_selector', array( 'h5' ) );
            $this->settings = petszone_customizer_settings('h5_typo');

            add_filter( 'petszone_plus_customizer_default', array( $this, 'default' ) );
            add_action( 'customize_register', array( $this, 'register' ), 20);

            add_filter( 'petszone_h5_typo_customizer_update', array( $this, 'h5_typo_customizer_update' ) );
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new PetsZone_Customize_Section(
                    ...
                    'site-h5-section',
                    array(
                        'title'    => esc_html__('H5 Typography', 'petszone-plus'),
             ...
             */
                $wp_customize->add_setting(
                    PETSZONE_CUSTOMISER_VAL . '[h5_typo]', array(
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new PetsZone_Customize_Control_Typography(
                        $wp_customize, PETSZONE_CUSTOMISER_VAL . '[h5_typo]', array(
                            'type'    => 'wdt-typography',
                            'section' => 'site-h5-section',
                            'label'   => esc_html__( 'H5 Tag', 'petszone-plus'),
                        )
                    )
                );
             ...
             */
                $wp_customize->add_setting(
                    PETSZONE_CUSTOMISER_VAL . '[h5_color]', array(
                        'default' => '',
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new WP_Customize_Color_Control(
                        $wp_customize, PETSZONE_CUSTOMISER_VAL . '[h5_color]', array(
        ...
        function h5_typo_customizer_update( $defaults ) {
            $h5_typo = petszone_customizer_settings( 'h5_typo' );
            if( !empty( $h5_typo ) ) {
                return  $h5_typo;
            }
            return $defaults;
        ...
        function base_style( $style ) {
            $css   = '';
            $color = petszone_customizer_settings('h5_color');
...
PetsZonePlusH5Settings::instance();