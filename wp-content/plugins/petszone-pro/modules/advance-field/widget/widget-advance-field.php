...
class PetsZone_Widget_Advance_Field extends WP_Widget {

    #1.constructor
	function __construct() {
		$widget_options = array(
			'classname'   => 'widget_advance_field',
			'description' => esc_html__('To add advance field', 'petszone-pro')
		);

        $theme_name =  defined('PETSZONE_THEME_NAME') ? PETSZONE_THEME_NAME : 'PetsZone';
		parent::__construct( false, $theme_name . esc_html__(' Advanced Fields','petszone-pro'), $widget_options );
	}
	...
	?>
		...
		<p>
        	<label for="<?php echo esc_attr($this->get_field_id('sub_title')); ?>">
        		<?php esc_html_e('Sub Title:','petszone-pro');?>
		...
		<p>
        	<label for="<?php echo esc_attr($this->get_field_id('description')); ?>">
        		<?php esc_html_e('Description:','petszone-pro');?>
		...
		<p>
        	<label for="<?php echo esc_attr($this->get_field_id('button_text')); ?>">
        		<?php esc_html_e('Button Text:','petszone-pro');?>
		...
		<p>
        	<label for="<?php echo esc_attr($this->get_field_id('button_url')); ?>">
        		<?php esc_html_e('Button Link:','petszone-pro');?>
		...
		<p>        
			...
			<label for="<?php echo esc_attr($this->get_field_id('image_url')); ?>">
        		<?php esc_html_e('Image Link:','petszone-pro');?>
