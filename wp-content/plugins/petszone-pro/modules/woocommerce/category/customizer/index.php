...
if( !class_exists( 'PetsZone_Pro_Listing_Customizer_Category' ) ) {

    class PetsZone_Pro_Listing_Customizer_Category {
        ...
        function default( $option ) {
            ...
            $settings = petszone_woo_listing_category()->woo_default_settings();
            extract($settings);
        ...
        function category_page_default_settings( $settings ) {
            ...
            $product_style_custom_template = petszone_customizer_settings('wdt-woo-category-page-product-style-template' );
            ...
            $product_per_page              = petszone_customizer_settings('wdt-woo-category-page-product-per-page' );
            $settings['product_per_page']  = $product_per_page;

            $product_layout                = petszone_customizer_settings('wdt-woo-category-page-product-layout' );
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new PetsZone_Customize_Section(
                    ...
                    array(
                        'title'    => esc_html__('Category Page', 'petszone-pro'),
                 ...
                 */
                    $wp_customize->add_setting(
                        PETSZONE_CUSTOMISER_VAL . '[wdt-woo-category-page-product-style-template]', array(
                            'type'              => 'option',
                        )
                    );
                    ...
                    $wp_customize->add_control(
                        new PetsZone_Customize_Control(
                            $wp_customize, PETSZONE_CUSTOMISER_VAL . '[wdt-woo-category-page-product-style-template]', array(
                                'type'     => 'select',
                 ...
                 */
                    $wp_customize->add_setting(
                        PETSZONE_CUSTOMISER_VAL . '[wdt-woo-category-page-product-per-page]', array(
                            'type' => 'option',
                        )
                    );
                    ...
                    $wp_customize->add_control(
                        new PetsZone_Customize_Control(
                            $wp_customize, PETSZONE_CUSTOMISER_VAL . '[wdt-woo-category-page-product-per-page]', array(
                                'type'        => 'number',
                 ...
                 */
                    $wp_customize->add_setting(
                        PETSZONE_CUSTOMISER_VAL . '[wdt-woo-category-page-product-layout]', array(
                            'type' => 'option',
                        )
                    );

                    $wp_customize->add_control( new PetsZone_Customize_Control_Radio_Image(
                        $wp_customize, PETSZONE_CUSTOMISER_VAL . '[wdt-woo-category-page-product-layout]', array(
                            'type' => 'wdt-radio-image',
                            'label' => esc_html__( 'Columns', 'petszone-pro'),
                            'section' => 'woocommerce-category-page-section',
                            'choices' => apply_filters( 'petszone_woo_category_columns_options', array(
                                1 => array(
                                    'label' => esc_html__( 'One Column', 'petszone-pro' ),
                                    'path' => PETSZONE_PRO_DIR_URL . 'modules/woocommerce/category/customizer/images/one-column.png'
                                ),
                                2 => array(
                                    'label' => esc_html__( 'One Half Column', 'petszone-pro' ),
                                    'path' => PETSZONE_PRO_DIR_URL . 'modules/woocommerce/category/customizer/images/one-half-column.png'
                                ),
                                3 => array(
                                    'label' => esc_html__( 'One Third Column', 'petszone-pro' ),
                                    'path' => PETSZONE_PRO_DIR_URL . 'modules/woocommerce/category/customizer/images/one-third-column.png'
                                ),
                                4 => array(
                                    'label' => esc_html__( 'One Fourth Column', 'petszone-pro' ),
                                    'path' => PETSZONE_PRO_DIR_URL . 'modules/woocommerce/category/customizer/images/one-fourth-column.png'
                                )
                            ))
                        )
                    ));
...
if( !function_exists('petszone_listing_customizer_category') ) {
	function petszone_listing_customizer_category() {
		return PetsZone_Pro_Listing_Customizer_Category::instance();
	}
}

petszone_listing_customizer_category();