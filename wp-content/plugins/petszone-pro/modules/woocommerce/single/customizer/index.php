...
if( !class_exists( 'PetsZone_Pro_Customizer_Single' ) ) {

    class PetsZone_Pro_Customizer_Single {
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_panel(
                new PetsZone_Customize_Panel(
                    ...
                    array(
                        'title'    => esc_html__('Product Single Page', 'petszone-pro'),
                ...
                $wp_customize->add_section(
                    new PetsZone_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Default Settings', 'petszone-pro'),
                ...
                $wp_customize->add_section(
                    new PetsZone_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Upsell Settings', 'petszone-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 20,
                        )
                    )
                ...
                $wp_customize->add_section(
                    new PetsZone_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Related Settings', 'petszone-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 30,
                        )
                    )
                ...
                $wp_customize->add_section(
                    new PetsZone_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Sociable Share Settings', 'petszone-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 40,
                        )
                    )
                ...
                $wp_customize->add_section(
                    new PetsZone_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Sociable Follow Settings', 'petszone-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 50,
                        )
                    )
...
if( !function_exists('petszone_customizer_single') ) {
	function petszone_customizer_single() {
		return PetsZone_Pro_Customizer_Single::instance();
	}
}

petszone_customizer_single();