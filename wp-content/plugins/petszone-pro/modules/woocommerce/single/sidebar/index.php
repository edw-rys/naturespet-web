...
if( !class_exists( 'PetsZone_Pro_Woo_single_Sidebar' ) ) {
    class PetsZone_Pro_Woo_single_Sidebar {
        ...
        function frontend() {
            ...
            add_filter('petszone_active_sidebars', array( $this, 'active_sidebars' ), 30 );
        }
        ...
        function primary_classes( $primary_class ) {
            ...
            if( is_product() ) {
                ...
                $settings = get_post_meta( $post_id, '_petszone_layout_settings', true );
...
PetsZone_Pro_Woo_single_Sidebar::instance();