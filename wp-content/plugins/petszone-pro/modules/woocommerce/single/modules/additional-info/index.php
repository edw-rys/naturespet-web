...
if( !class_exists( 'PetsZone_Shop_Single_Module_Additional_Info' ) ) {

    class PetsZone_Shop_Single_Module_Additional_Info {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( petszone_is_file_in_theme( __FILE__ ) ) {
                    return PETSZONE_MODULE_DIR . '/woocommerce/single/modules/additional-info/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( petszone_is_file_in_theme( __FILE__ ) ) {
                    return PETSZONE_MODULE_URI . '/woocommerce/single/modules/additional-info/';
                } else {
...
if( !function_exists('petszone_shop_single_module_additional_info') ) {
	function petszone_shop_single_module_additional_info() {
        $reflection = new ReflectionClass('PetsZone_Shop_Single_Module_Additional_Info');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'PetsZone_Shop_Single_Module_Custom_template' ) ) {
    PetsZone_Shop_Single_Module_Additional_Info::instance();
}