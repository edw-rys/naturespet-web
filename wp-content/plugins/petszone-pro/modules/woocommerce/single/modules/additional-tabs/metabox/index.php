...
if( !class_exists( 'PetsZone_Shop_Metabox_Single_Additional_Tabs' ) ) {
    class PetsZone_Shop_Metabox_Single_Additional_Tabs {
        ...
        function petszone_shop_product_custom_settings( $options ) {
			...
			$product_options = array (
				...
				array (
					...
					'type'            => 'group',
					'title'           => esc_html__('Additional Tabs', 'petszone-pro'),
					'info'            => esc_html__('Click button to add title and description.', 'petszone-pro'),
					'button_title'    => esc_html__('Add New Tab', 'petszone-pro'),
					'accordion_title' => esc_html__('Adding New Tab Field', 'petszone-pro'),
					'fields'          => array (
						...
						array (
							...
							'info'       => esc_html__('Choose "Elementor Templates" here to use for "Description", if you choose "Custom Description" option you can provide your own content below.', 'petszone-pro'),
...
PetsZone_Shop_Metabox_Single_Additional_Tabs::instance();