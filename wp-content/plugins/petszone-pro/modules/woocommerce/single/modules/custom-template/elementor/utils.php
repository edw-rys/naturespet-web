...
if(!function_exists('petszone_shop_product_tabs_exploded_html')) {
	function petszone_shop_product_tabs_exploded_html($attrs, $content = null) {
		...
		$attrs = shortcode_atts ( array (
			...
			'scroll_height' => '',
			'class'         => ''
		), $attrs, 'petszone_shop_product_tabs_exploded' );

		$out = petszone_shop_product_tabs_exploded_render_html($attrs);

		return $out;

	}
	add_shortcode( 'petszone_shop_product_tabs_exploded', 'petszone_shop_product_tabs_exploded_html' );
}


if(!function_exists('petszone_shop_product_tabs_exploded_render_html')) {
	function petszone_shop_product_tabs_exploded_render_html($settings) {
