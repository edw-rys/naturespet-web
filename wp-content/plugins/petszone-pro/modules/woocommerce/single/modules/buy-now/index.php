...
if( !class_exists( 'PetsZone_Shop_Single_Module_Buy_Now' ) ) {

    class PetsZone_Shop_Single_Module_Buy_Now {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( petszone_is_file_in_theme( __FILE__ ) ) {
                    return PETSZONE_MODULE_DIR . '/woocommerce/single/modules/buy-now/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( petszone_is_file_in_theme( __FILE__ ) ) {
                    return PETSZONE_MODULE_URI . '/woocommerce/single/modules/buy-now/';
                } else {
...
if( !function_exists('petszone_shop_single_module_buy_now') ) {
	function petszone_shop_single_module_buy_now() {
        $reflection = new ReflectionClass('PetsZone_Shop_Single_Module_Buy_Now');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'PetsZone_Shop_Single_Module_Custom_template' ) ) {
    PetsZone_Shop_Single_Module_Buy_Now::instance();
}