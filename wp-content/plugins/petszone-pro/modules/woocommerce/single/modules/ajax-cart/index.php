...
if( !class_exists( 'PetsZone_Shop_Single_Module_Ajax_Cart' ) ) {

    class PetsZone_Shop_Single_Module_Ajax_Cart {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( petszone_is_file_in_theme( __FILE__ ) ) {
                    return PETSZONE_MODULE_DIR . '/woocommerce/single/modules/ajax-cart/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( petszone_is_file_in_theme( __FILE__ ) ) {
                    return PETSZONE_MODULE_URI . '/woocommerce/single/modules/ajax-cart/';
                } else {
...
if( !function_exists('petszone_shop_single_module_ajax_cart') ) {
	function petszone_shop_single_module_ajax_cart() {
		return PetsZone_Shop_Single_Module_Ajax_Cart::instance();
	}
}

petszone_shop_single_module_ajax_cart();