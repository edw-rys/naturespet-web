...
if( !class_exists( 'PetsZone_Woo_Listing_Type_Custom' ) ) {

    class PetsZone_Woo_Listing_Type_Custom {
        ...
        function __construct() {
            ...
            /* Initialize Type */
                ...
                $this->type_name = esc_html__('Custom', 'petszone-pro');
        ...
        */
            function set_type_options() {
                ...
                if( strpos($this->custom_template, 'predefined-template-') !== false ) {
                    ...
                    $field_key = str_replace('predefined-template-', 'petszone-woo-product-style-template-',  $this->custom_template);
                    ...
                    $custom_options = ( isset($dtcs_product_templates['petszone-woo-product-style-templates'][$field_key]) && !empty($dtcs_product_templates['petszone-woo-product-style-templates'][$field_key]) ) ? $dtcs_product_templates['petszone-woo-product-style-templates'][$field_key] : array ();
            ...
            function for_non_archive_listing() {
                ...
                /* Assets Load */
                    ...
                    // CSS
                        ...
                        wp_register_style( 'petszone-woo-non-archive', '', array (), PETSZONE_PRO_VERSION, 'all' );
...
if( !function_exists('petszone_woo_listing_type_custom') ) {
	function petszone_woo_listing_type_custom() {
		return PetsZone_Woo_Listing_Type_Custom::instance();
	}
}

petszone_woo_listing_type_custom();