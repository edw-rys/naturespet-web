...
if( !class_exists( 'PetsZone_Shop_Others_Cart' ) ) {

    class PetsZone_Shop_Others_Cart {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( petszone_is_file_in_theme( __FILE__ ) ) {
                    return PETSZONE_MODULE_DIR . '/woocommerce/others/cart/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( petszone_is_file_in_theme( __FILE__ ) ) {
                    return PETSZONE_MODULE_URI . '/woocommerce/others/cart/';
                } else {
...
if( !function_exists('petszone_shop_others_cart') ) {
	function petszone_shop_others_cart() {
        $reflection = new ReflectionClass('PetsZone_Shop_Others_Cart');
        return $reflection->newInstanceWithoutConstructor();
	}
}

PetsZone_Shop_Others_Cart::instance();