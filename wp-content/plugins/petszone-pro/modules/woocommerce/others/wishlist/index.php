...
if( !class_exists( 'PetsZone_Shop_Others_Wishlist' ) ) {

    class PetsZone_Shop_Others_Wishlist {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( petszone_is_file_in_theme( __FILE__ ) ) {
                    return PETSZONE_MODULE_DIR . '/woocommerce/others/wishlist/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( petszone_is_file_in_theme( __FILE__ ) ) {
                    return PETSZONE_MODULE_URI . '/woocommerce/others/wishlist/';
                } else {
...
if( !function_exists('petszone_shop_others_wishlist') ) {
	function petszone_shop_others_wishlist() {
        $reflection = new ReflectionClass('PetsZone_Shop_Others_Wishlist');
        return $reflection->newInstanceWithoutConstructor();
	}
}

PetsZone_Shop_Others_Wishlist::instance();