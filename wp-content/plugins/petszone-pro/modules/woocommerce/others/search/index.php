...
if( !class_exists( 'PetsZone_Shop_Others_Search' ) ) {

    class PetsZone_Shop_Others_Search {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( petszone_is_file_in_theme( __FILE__ ) ) {
                    return PETSZONE_MODULE_DIR . '/woocommerce/others/search/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( petszone_is_file_in_theme( __FILE__ ) ) {
                    return PETSZONE_MODULE_URI . '/woocommerce/others/search/';
                } else {
         ...
         */
            function module_add_new_page_template( $templates ) {
                ...
                $templates = array_merge (
                    $templates,
                    array (
                        'tpl-product-search-listing.php' => esc_html__('Product Search Listing Template', 'petszone-pro')
                    )
                );
...
if( !function_exists('petszone_shop_others_search') ) {
	function petszone_shop_others_search() {
        $reflection = new ReflectionClass('PetsZone_Shop_Others_Search');
        return $reflection->newInstanceWithoutConstructor();
	}
}

PetsZone_Shop_Others_Search::instance();