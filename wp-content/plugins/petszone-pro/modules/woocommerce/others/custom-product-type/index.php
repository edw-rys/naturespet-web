...
if( !class_exists( 'PetsZone_Shop_Others_Custom_Product_Type' ) ) {

    class PetsZone_Shop_Others_Custom_Product_Type {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( petszone_is_file_in_theme( __FILE__ ) ) {
                    return PETSZONE_MODULE_DIR . '/woocommerce/others/custom-product-type/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( petszone_is_file_in_theme( __FILE__ ) ) {
                    return PETSZONE_MODULE_URI . '/woocommerce/others/custom-product-type/';
                } else {
...
if( !function_exists('petszone_shop_others_custom_product_type') ) {
	function petszone_shop_others_custom_product_type() {
        $reflection = new ReflectionClass('PetsZone_Shop_Others_Custom_Product_Type');
        return $reflection->newInstanceWithoutConstructor();
	}
}

PetsZone_Shop_Others_Custom_Product_Type::instance();