...
if( !class_exists( 'PetsZone_Shop_Others_Recently_Viewed_Products_Include' ) ) {

    class PetsZone_Shop_Others_Recently_Viewed_Products_Include {
        ...
        function __construct() {
			...
			add_action( 'petszone_hook_bottom', array( $this, 'petszone_shop_recently_viewed_products_content' ) );
			add_action( 'wp', array( $this, 'petszone_shop_set_recently_viewed_products' ) );
         ...
         */
			function petszone_shop_recently_viewed_products_content() {
							...
							echo '<div class="wdt-shop-recently-viewed-products-holder">';
								...
								echo '<div class="wdt-shop-recently-viewed-products-wrapper">';
									...
									echo '<div class="wdt-shop-recently-viewed-products-title">';
										echo esc_html__('Recently Viewed', 'petszone-pro');
									echo '</div>';
											...
											while ( $products->have_posts() ) {
												...
												echo '<div class="wdt-shop-recently-viewed-product swiper-slide">';
													...
													echo '<div class="wdt-shop-recently-viewed-product-info">';
														...
														echo '<div class="title"><a href="'.esc_url( $product->get_permalink() ).'">'.esc_attr($product->get_title()).'</a></div>';
														...
														if( !empty($add_to_cart) ) {
															...
															echo '<div class="wcct_btn_wrapper wc_btn_inline" data-tooltip="'.esc_attr__('Add To Cart', 'petszone-pro' ).'">'.petszone_html_output($add_to_cart).'</div>';
						...
						echo '<div class="wdt-shop-recently-viewed-products-holder">';
							...
							echo '<div class="wdt-shop-recently-viewed-products-wrapper">';
								...
								echo '<div class="wdt-shop-recently-viewed-products-container">';
									echo esc_html__('Sorry, there are no products.', 'petszone-pro');
								echo '</div>';
         ...
         */
			function petszone_shop_set_recently_viewed_products() {
				if(is_product()) {
...
if( !function_exists('petszone_shop_others_recently_viewed_products_include') ) {
	function petszone_shop_others_recently_viewed_products_include() {
        $reflection = new ReflectionClass('PetsZone_Shop_Others_Recently_Viewed_Products_Include');
        return $reflection->newInstanceWithoutConstructor();
	}
}

PetsZone_Shop_Others_Recently_Viewed_Products_Include::instance();