...
if( !class_exists( 'PetsZone_Shop_Others_Recently_Viewed_Products' ) ) {

    class PetsZone_Shop_Others_Recently_Viewed_Products {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( petszone_is_file_in_theme( __FILE__ ) ) {
                    return PETSZONE_MODULE_DIR . '/woocommerce/others/recently-viewed-products/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( petszone_is_file_in_theme( __FILE__ ) ) {
                    return PETSZONE_MODULE_URI . '/woocommerce/others/recently-viewed-products/';
                } else {
...
if( !function_exists('petszone_shop_others_recently_viewed_products') ) {
	function petszone_shop_others_recently_viewed_products() {
        $reflection = new ReflectionClass('PetsZone_Shop_Others_Recently_Viewed_Products');
        return $reflection->newInstanceWithoutConstructor();
	}
}

PetsZone_Shop_Others_Recently_Viewed_Products::instance();