...
if( !class_exists( 'PetsZoneProPostSimple' ) ) {
    class PetsZoneProPostSimple {
        ...
        function add_post_styles_option( $options ) {
            $options['simple'] = esc_html__('Simple', 'petszone-pro');
            return $options;
        }
        ...
        function add_post_hook_container_before() {
            ...
            if(is_singular('post')) {
                ...
                echo '<div class="post-simple post-header">';
                    petszone_template_part( 'post', 'templates/simple/parts/date', '', $template_args );
                    if( $template_args['enable_title'] ) :
                        petszone_template_part( 'post', 'templates/post-extra/title', '', $template_args );
                    endif;
                    petszone_template_part( 'post', 'templates/simple/parts/category', '', $template_args );
                echo '</div>';
                echo ob_get_clean();
...
PetsZoneProPostSimple::instance();