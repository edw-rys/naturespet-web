...
if( !class_exists( 'PetsZoneProPostModern' ) ) {
    class PetsZoneProPostModern {
        ...
        function __construct() {
            ...
            add_action( 'petszone_hook_container_before', array( $this, 'add_post_hook_container_before' ) );
        }

        function add_post_styles_option( $options ) {
            $options['modern'] = esc_html__('Modern', 'petszone-pro');
            return $options;
        }
            ...
            if(is_singular('post')) {
                ...
                echo '<div class="post-modern">';
                    echo '<div class="post-single-image">';
                        petszone_template_part( 'post', 'templates/'.$post_style.'/parts/image', '', $template_args );
                    echo '</div>';
                    ?>
                            ...
                            if( !empty( $prev_post ) ):	?>
                                ...
                                <div class="post-prev-link"><?php
                                    ...
                                    <div class="nav-title-wrap">
                                        ...
                                        <p><a href="<?php echo get_permalink( $prev_post->ID ); ?>" title="<?php echo esc_attr($prev_post->post_title); ?>"><?php esc_html_e('Prev','petszone-pro'); ?></a></p>
                                        <h3><a href="<?php echo get_permalink( $prev_post->ID ); ?>" title="<?php echo esc_attr($prev_post->post_title); ?>"><?php
                                            if( get_the_title( $prev_post->ID ) == '') {
                                                echo esc_html__('Previous Post', 'petszone-pro');
                                            } else {
                                                petszone_html_output($prev_post->post_title);
                                            } ?></a>
                                        </h3>
                                    </div>
                                ...
                                <div class="post-prev-link no-post">
                                    <a href="#" style="background-image:url(<?php echo esc_url(PETSZONE_ROOT_URI.'/assets/images/no-post.jpg') ?>);" class="prev-post-bgimg"></a>
                                    <div class="nav-title-wrap">
                                        <span class="zmdi zmdi-long-arrow-left zmdi-hc-fw"></span>
                                        <h3><?php echo esc_html__('No previous story to show!', 'petszone-pro'); ?></h3>
                                    </div>
                                </div>
                                <?php
                            endif;
                            ...
                            if( !empty( $next_post ) ):	?>
                                <div class="post-next-link"><?php
                                    ...
                                    <div class="nav-title-wrap">
                                        ...
                                        <p><a href="<?php echo get_permalink( $next_post->ID ); ?>" title="<?php echo esc_attr($next_post->post_title); ?>"><?php esc_html_e('Next','petszone-pro'); ?></a></p>
                                        <h3><a href="<?php echo get_permalink( $next_post->ID ); ?>" title="<?php echo esc_attr($next_post->post_title); ?>"><?php
                                            if(get_the_title( $next_post->ID ) == '') {
                                                echo esc_html__('Next Post', 'petszone-pro');
                                            } else {
                                                petszone_html_output($next_post->post_title);
                                            } ?></a>
                                        </h3>
                                    </div>
                                ...
                                <div class="post-next-link no-post">
                                    <a href="#" style="background-image:url(<?php echo esc_url(PETSZONE_ROOT_URI.'/assets/images/no-post.jpg') ?>);" class="next-post-bgimg"></a>
                                    <div class="nav-title-wrap">
                                        <span class="zmdi zmdi-long-arrow-right zmdi-hc-fw"></span>
                                        <h3><?php echo esc_html__('No next story to show!', 'petszone-pro'); ?></h3>
                                    </div>
                                </div>
                                <?php
                            endif;
...
PetsZoneProPostModern::instance();