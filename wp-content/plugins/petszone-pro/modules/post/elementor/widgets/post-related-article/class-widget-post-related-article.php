...
class Elementor_Post_Related_Article extends PetsZoneElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Related Article', 'petszone-pro');
    }
    ...
    protected function render() {
        ...
        $out .= petszone_get_template_part( 'post', 'templates/post-extra/related_article', '', $template_args );
